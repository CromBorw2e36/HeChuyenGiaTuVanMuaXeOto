...
vehicle_line('V8-Vantage-2021',manufacturer('aston-martin'), ar_engine('4_0_twin_turbo_v8')).

vehicle_line('DBS-2021_DBX-2021_V8-Vantage-2021', manufacturer('aston-martin'))
%Audi
